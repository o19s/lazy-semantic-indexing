...
semIdx = Index(source=[("0", asTermVect("The bear eats")),
                       ...
                       ("2", asTermVect("The cat eats the dog")),
                       ("3", asTermVect("The bear")),
                       ("4", asTermVect("The cat"))
...
print()
print("st doc 0 %s" % semIdx.getBlurredTerms('0', cutoff=-5,stops=1)[1])
print("st doc 1 %s" % semIdx.getBlurredTerms('1', cutoff=-5,stops=1)[1])
print("st doc 2 %s" % semIdx.getBlurredTerms('2', cutoff=-5,stops=1)[1])
